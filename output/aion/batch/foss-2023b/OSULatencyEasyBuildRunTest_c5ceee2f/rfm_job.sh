#!/bin/bash
#SBATCH --job-name="rfm_OSULatencyEasyBuildRunTest_c5ceee2f"
#SBATCH --ntasks=2
...
echo "--- START PRERUN CMDS for Latency same_numa ---"
...
srun --cpus-per-task=1 --cpu-bind=cores osu_latency -m 8192:8192 -x 100 -i 1000
