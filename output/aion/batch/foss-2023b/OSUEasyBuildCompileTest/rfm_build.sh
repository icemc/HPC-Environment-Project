...
echo "DEBUG [Build]: Copying /mnt/aiongpfs/users/fkusek/HPC-Environment-Project/reframe/easybuild/OSU-Micro-Benchmarks-7.2-foss-2023b.eb to /mnt/aiongpfs/users/fkusek/HPC-Environment-Project/stage/aion/batch/foss-2023b/OSUEasyBuildCompileTest/OSU-Micro-Benchmarks-7.2-foss-2023b.eb"
cp "/mnt/aiongpfs/users/fkusek/HPC-Environment-Project/reframe/easybuild/OSU-Micro-Benchmarks-7.2-foss-2023b.eb" "/mnt/aiongpfs/users/fkusek/HPC-Environment-Project/stage/aion/batch/foss-2023b/OSUEasyBuildCompileTest/OSU-Micro-Benchmarks-7.2-foss-2023b.eb"
echo "DEBUG [Build]: Verifying staged .eb file: $(ls -l /mnt/aiongpfs/users/fkusek/HPC-Environment-Project/stage/aion/batch/foss-2023b/OSUEasyBuildCompileTest/OSU-Micro-Benchmarks-7.2-foss-2023b.eb || echo STAGED_EB_NOT_FOUND)"
