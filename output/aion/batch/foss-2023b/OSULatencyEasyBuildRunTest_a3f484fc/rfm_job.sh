#!/bin/bash
#SBATCH --job-name="rfm_OSULatencyEasyBuildRunTest_a3f484fc"
#SBATCH --ntasks=2
...
echo "--- START PRERUN CMDS for Latency default ---"
...
srun --cpus-per-task=1 --cpu-bind=core osu_latency -m 8192:8192 -x 100 -i 1000
