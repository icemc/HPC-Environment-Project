#!/bin/bash
#SBATCH --job-name="rfm_OSUBandwidthEasyBuildRunTest_d12cb8c9"
#SBATCH --ntasks=2
...
echo "--- START PRERUN CMDS for Bandwidth default ---"
...
srun --cpus-per-task=1 --cpu-bind=core osu_bw -m 1048576:1048576 -x 10 -i 100
