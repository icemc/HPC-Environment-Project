#!/bin/bash
#SBATCH --job-name="rfm_OSUBandwidthEasyBuildRunTest_f31778c4"
#SBATCH --ntasks=2
...
echo "--- START PRERUN CMDS for Bandwidth same_numa ---"
...
srun --cpus-per-task=1 --cpu-bind=cores osu_bw -m 1048576:1048576 -x 10 -i 100
